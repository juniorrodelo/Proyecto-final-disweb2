...
<div class="mainwrapper">
    ...
    <div class="errortitle"  >
        <h4 class="animate0 fadeInUp"> Hola  <?php echo $_SESSION['nombre']; ?>, Esta Sección estará habilitada próximamente.</h4>
        <span class="animate1 bounceIn" style="background:#fff;"><img src="images/404.png" alt=""></span>
 
        <div class="errorbtns animate4 fadeInUp">
            <a onclick="history.back()" class="btn btn-primary btn-large">Página Anterior</a>
            <a href="dashboard.php" class="btn btn-large">Área Personal</a>
        </div>
    </div>
